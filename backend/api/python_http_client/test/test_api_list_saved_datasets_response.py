...
import frs_api
from frs_api.models.api_list_saved_datasets_response import ApiListSavedDatasetsResponse  # noqa: E501
from frs_api.rest import ApiException

class TestApiListSavedDatasetsResponse(unittest.TestCase):
    """ApiListSavedDatasetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ApiListSavedDatasetsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = frs_api.models.api_list_saved_datasets_response.ApiListSavedDatasetsResponse()  # noqa: E501
        if include_optional :
            return ApiListSavedDatasetsResponse(
                saved_datasets = [
                    frs_api.models.api_saved_dataset.apiSavedDataset(
                        name = '0', 
                        project = '0', 
                        features = [
                            '0'
    ...
    def testApiListSavedDatasetsResponse(self):
        """Test ApiListSavedDatasetsResponse"""
