...
var (
	filter_DataSourceService_GetDataSource_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_DataSourceService_GetDataSource_0(ctx context.Context, marshaler runtime.Marshaler, client DataSourceServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_DataSourceService_GetDataSource_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_DataSourceService_DeleteDataSource_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func RegisterDataSourceServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DataSourceServiceServer) error {
	...
	mux.Handle("POST", pattern_DataSourceService_UpdateDataSource_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
...
var (
	pattern_DataSourceService_CreateDataSource_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"CreateDataSource"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataSourceService_GetDataSource_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"GetDataSource"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataSourceService_UpdateDataSource_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"UpdateDataSource"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataSourceService_DeleteDataSource_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"DeleteDataSource"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_DataSourceService_ListDataSources_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"ListDataSources"}, "", runtime.AssumeColonVerbOpt(true)))
)
