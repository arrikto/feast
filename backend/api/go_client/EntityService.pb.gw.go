...
var (
	filter_EntityService_GetEntity_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	filter_EntityService_DeleteEntity_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	pattern_EntityService_CreateEntity_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"CreateEntity"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EntityService_GetEntity_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"GetEntity"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EntityService_UpdateEntity_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"UpdateEntity"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EntityService_DeleteEntity_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"DeleteEntity"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EntityService_ListEntities_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"ListEntities"}, "", runtime.AssumeColonVerbOpt(true)))
)
